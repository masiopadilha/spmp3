...
if (GetKeyState(VK_CONTROL) and 128 > 0) = False then
  begin
    ...
    TSManut.Caption := 'Manuten��es ('+ IntToStr(DM.qryManutVenc.RecordCount)+')';
    TSLubrific.Caption := 'Lubrifica��es ('+ IntToStr(DM.qryLubrificVenc.RecordCount)+')';
  end;
end;
...
case PCInspecoes.ActivePageIndex of
  ...
  2:
    Begin
      ...
      GrdRotas.Columns[0].Title.Caption   := 'Descri��o';
