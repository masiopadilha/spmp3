      ...
      begin
        ...
        while not DM.qryOrdemServicoEquipeMObra.Eof = True do
          begin
            ...
            //DM.qryOrdemServicoEquipeMObraCODCALENDARIO.AsString := EmptyStr;
            //DM.qryOrdemServicoEquipeMObraCALENDARIO.AsString    := EmptyStr;
...
//    EdtDataProgIni.Date    := DM.FDataHoraServidor;
//    EdtHoraProgIni.Time    := DM.FDataHoraServidor;
//
//    EdtDataProgFin.Date    := DM.FDataHoraServidor;
//    EdtHoraProgFin.Time    := DM.FDataHoraServidor;
//
//    EdtDataProgIni.MinDate := DateOf(DM.FDataHoraServidor);
//    EdtHoraProgIni.MinDate := TimeOf(DM.FDataHoraServidor);
//
//    EdtDataProgFin.MinDate := DateOf(DM.FDataHoraServidor);
//    EdtHoraProgFin.MinDate := TimeOf(DM.FDataHoraServidor);
...
//                DM.qryOrdemServicoMObraProgCODIGO.AsInteger          := DM.qryOrdemServicoMObraProg.RecordCount + 1;
