...
type
  TDM = class(TDataModule)
    ...
    qryOrdemServicoGerenciaRelatEQUIPAMENTO: TStringField;
    ...
    qryOrdemServicoGerenciaRelatCODFAMEQUIP: TStringField;
    ...
    qryOSGerenciaRelatManut: TFDQuery;
    ...
    dsOSGerenciaRelatManut: TDataSource;
    qryOSGerenciaRelatLubrific: TFDQuery;
    ...
    dsOSGerenciaRelatLubrific: TDataSource;
