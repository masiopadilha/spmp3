  ...
  if FrmTelaInspVenc <> nil then
    begin
      if DM.qryManutVenc.Active = True then
        FrmTelaInspVenc.TSManut.Caption := 'Manuten��es ('+ IntToStr(DM.qryManutVenc.RecordCount)+')';
      //FrmTelaInspVenc.TSLubrific.Caption := 'Lubrifica��es ('+ IntToStr(CMWeb.CDCadLubrificVenc.RecordCount)+')';
    end;
end;
  ...
  if (DM.qryManutVenc.IsEmpty = False) or (DM.qryLubrificVenc.IsEmpty = False) or (DM.qryRotaEquipVenc.IsEmpty = False) then
    begin
      Try
        ...
        FrmTelaInspVenc.TSManut.Caption := 'Manuten��es ('+ IntToStr(DM.qryManutVenc.RecordCount)+')';
        FrmTelaInspVenc.TSLubrific.Caption := 'Lubrifica��es ('+ IntToStr(DM.qryLubrificVenc.RecordCount)+')';
        if DM.FEmpTransf = True then
          begin
