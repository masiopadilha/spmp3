...
//                      DM.qryManutProgEquipDTAINICIO1.AsDateTime := IncDay(DM.FDataHoraServidor, DM.qryManutProgEquipFREQUENCIA1.AsInteger);
  ...
  //                DM.qryOrdemServicoServSolic.Params[0].AsString  := DM.FCodEmpresa;
              ...
              TSManut.Caption := 'Manuten��es ('+IntToStr(DM.qryManutPeriodicas.RecordCount)+')';
            End;
...
//                DM.qryOrdemServicoServSolic.Params[0].AsString  := DM.FCodEmpresa;
              ...
              TSLubrific.Caption := 'Lubrifica��es ('+IntToStr(DM.qryLubrificPeriodicas.RecordCount)+')';
            End;
...
GrdItensLubrific.Columns[10].Title.Caption   := 'Inspe��o';
...
GrdRotaManut.Columns[5].Title.Caption   := 'Inspe��o';
DM.qryRotaPeriodicasManut.Fields[5].DisplayWidth := 20;
GrdRotaManut.Columns[16].Title.Caption   := 'C�digo';
...
GrdRotaManutItens.Columns[10].Title.Caption   := 'Inspe��o';  DM.qryRotaPeriodicasManutItens.Fields[10].DisplayWidth := 45;
...
GrdRotaManutItensEsp.Columns[10].Title.Caption   := 'Inspe��o';  DM.qryRotaPeriodicasManutItensEsp.Fields[10].DisplayWidth := 45;
...
GrdItensManut.Columns[10].Title.Caption   := 'Inspe��o';  DM.qryManutPeriodicasItens.Fields[10].DisplayWidth := 45;
...
GrdItensEspLubrific.Columns[10].Title.Caption   := 'Inspe��o';
...
GrdItensEspManut.Columns[10].Title.Caption   := 'Inspe��o';
