inherited FrmTelaCadLubrificProgFamEquipConsulta: TFrmTelaCadLubrificProgFamEquipConsulta
  Caption = 'Consulta das Lubrifica'#231#245'es'
  ClientHeight = 641
  ClientWidth = 1008
  ...
  inherited PCentro: TPanel
    ...
    object DBGrid: TJvDBGrid
      ...
      Height = 455
      Align = alClient
      DataSource = DM.dsLubrificProgFamEquipCons
      ...
      Columns = <
        ...
        item
          ...
          Title.Alignment = taCenter
          Title.Caption = 'C'#243'd. Lubrific.'
          Visible = True
        end
        item
          Expanded = False
        ...
        item
          ...
          Title.Alignment = taCenter
          Title.Caption = 'C'#243'd. Lubrific. Fam.'
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'DESCLUBRIFICFAMILIA'
          Title.Caption = 'Lubrifica'#231#227'o de Fam'#237'lia'
          Width = 305
          Visible = True
        end>
    end
