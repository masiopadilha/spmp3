...
//        FDMemTManutPlanoTrab.Close;
        ...
        TSManut.Caption := 'Manuten��es ('+ IntToStr(FDMemTManut.RecordCount)+')';
...
//        end;
      ...
      if Application.MessageBox(LTexto, 'SPMP3', MB_YESNO + MB_ICONQUESTION) = IDYes then
        begin
          ...
          TSManut.Caption := 'Manuten��es ('+ IntToStr(DM.qryManutCons.RecordCount)+')';
        end;
    end;
  1: //Lubrifica��es
    begin
...
//        end;
      ...
      if Application.MessageBox(LTexto, 'SPMP3', MB_YESNO + MB_ICONQUESTION) = IDYes then
        begin
          ...
          TSLubrific.Caption := 'Lubrifica��es ('+ IntToStr(DM.qryLubrificCons.RecordCount)+')';
        end;
    end;
  2:
    begin
  ...
  Case CBPeriodo.ItemIndex of
    0: //Vencidas
      Begin
        ...
        TSManut.Caption := 'Manuten��es ('+ IntToStr(GrdManut.DataSource.DataSet.RecordCount)+')';
        ...
        TSLubrific.Caption := 'Lubrifica��es ('+ IntToStr(GrdLubrific.DataSource.DataSet.RecordCount)+')';
  ...
  case PCInspecoes.ActivePageIndex of
    0:
      Begin
        ...
        GrdManut.Columns[0].Title.Caption   := 'Descri��o';
        ...
        GrdManut.Columns[3].Title.Caption   := 'C�d. Equip.';
...
//            end;
    ...
    1:
      Begin
        ...
        GrdLubrific.Columns[0].Title.Caption   := 'Descri��o';
        ...
        GrdLubrific.Columns[3].Title.Caption   := 'C�d. Equip.';
    ...
    2:
      Begin
        ...
        GrdRota.Columns[0].Title.Caption   := 'Descri��o';
